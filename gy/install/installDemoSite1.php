...
$APP->component(
    ...
    array( 
        \'html\' => \'<div class="content">
            ...
            <b>Новости</b><br/>
            Для этого нужно перейти в админ панели в раздел “Контейнеры данных” далее в таблице, по столбцу “name”,  найти строчку “Новости” нажать “ Работа с элементами контейнера данных”. Перед вами все новости, для изменения нужно зайти в “Просмотреть свойства элемента” там будет “Детальный текст”, “Превью текст” и “Дата новости”. Также можно удалить пункты меню или добавить новые.
            </p>
